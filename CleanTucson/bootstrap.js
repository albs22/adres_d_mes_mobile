...
Ext.ClassManager.addNameAlternateMappings({
  "CleanTucson.controller.Create": [],
  "CleanTucson.controller.Detail": [],
  "CleanTucson.controller.Home": [],
  "CleanTucson.controller.List": [],
  "CleanTucson.model.Violation": [],
  ...
  "CleanTucson.view.MainTitleBar": [],
  "CleanTucson.view.Map": [],
  "CleanTucson.view.MapContainer": [],
  "CleanTucson.view.SelectLocation": [],
  "CleanTucson.view.SubmitContainer": [],
  "CleanTucson.view.SubmitForm": [],
  "CleanTucson.view.Test": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "CleanTucson.view.SelectLocation": [
    "widget.selectLocataionMap"
  ],
  "CleanTucson.view.SubmitContainer": [
    "widget.submitContainer"
  ],
  "CleanTucson.view.SubmitForm": [
    "widget.violationSubmit"
  ],
  "CleanTucson.view.Test": [],
  "CleanTucson.view.ViolationList": [
    "widget.violationList"
  ],
  "Ext.AbstractComponent": [],
  "Ext.AbstractManager": [],
  "Ext.AbstractPlugin": [],
